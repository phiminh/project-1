...
<form action="modules/quanlyloaisp/xuly.php" method="post" enctype="multipart/form-data">
  <h1 id="litheader">THÊM LOẠI SP</h1>
  <div class="inset">
    <p>
      <input type="text" name="tenloaisp" id="tenloaisp" placeholder="Tên loại sp">
    </p>
    <p>
      <input type="text" name="thutu" id="thutu" placeholder="Thứ tự">
    </p>
